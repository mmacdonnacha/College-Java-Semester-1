...
public class FourSquareCipherExtended {

    final private String ALPHABET = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 ,.():#-*_;'\"";
    final int SIZE = (int)Math.sqrt(ALPHABET.length()) * 2;
